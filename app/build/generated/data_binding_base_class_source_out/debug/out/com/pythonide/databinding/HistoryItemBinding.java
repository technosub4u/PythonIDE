...
public final class HistoryItemBinding implements ViewBinding {
  ...
  private HistoryItemBinding(@NonNull MaterialCardView rootView, @NonNull TextView historyText) {
  ...
  public static HistoryItemBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new HistoryItemBinding((MaterialCardView) rootView, historyText);
    }
